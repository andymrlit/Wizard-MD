 ...
 *CLONE:* $ git clone ${repo.clone_url} 
 ...
  urlButton: { 
   displayText: 'SCRIPT', 
   url: 'https://github.com/andymrlit' 
  } 
   }] 
  fatihgans = thumbwiz 
 ...
 *Response In* ${latensi.toFixed(4)}`.trim() 
 ...
         `, 
          buttonText: "SET MENU", 
          footerText: creator andymrlit X Maxi
...
 𝚜𝚙𝚑𝚒𝚗𝚡 -𝚙𝚑𝚘𝚝𝚘- 
 ...
     const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://instagram.com/andymrlit` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/andymrlit` } }, 
     {                                         
       quickReplyButton: { 
       displayText: 'SPEED', 
       id: 'ping' 
 ...
 *🗃️Ram Usage:* ${ram2} 
 ...
 "urlButton": { 
 "displayText": "SUBSCRIBE", 
 "url": "https://instagram.com/andymrlit" 
 } 
 }, { 
 urlButton: { 
 displayText: 'GITHUB', 
